...
namespace TinyGiantStudio.PackageImporter
{
    internal class TGS_PackageImporterWindow : EditorWindow
    {
        ...
        void OnEnable()
        {
            ...
            dontAutoCheckUpdate = EditorPrefs.GetBool("DontAutoCheckForUpdates");
        ...
        void OnGUI()
        {
            ...
            {
                EditorPrefs.SetBool("AutoCheckForUpdates", dontAutoCheckUpdate);
            }
        }
        void DrawAssetsList()
        {
        ...
        void BottomInformation()
        {
            ...
            GUILayout.FlexibleSpace();
            dontAutoCheckUpdate = !EditorGUILayout.Toggle(v, !dontAutoCheckUpdate);
            GUILayout.EndVertical();
