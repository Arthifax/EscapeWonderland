...
namespace TinyGiantStudio.Text
{
    ...
    public class Modular3DText : MonoBehaviour
    {
        ...
        /// <summary>
        /// Named UV Remapping in the inspector.
        /// Dectates if additional post processing is done on the mesh.
        /// Project UV is default and means no additional calculation is done.
