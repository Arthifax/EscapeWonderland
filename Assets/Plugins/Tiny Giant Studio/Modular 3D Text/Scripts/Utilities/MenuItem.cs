...
namespace TinyGiantStudio.Text
{
    public class MenuItem : MonoBehaviour //monobehaviour is required for destroy immediate/instantiate etc.
    {
        ...
        static void CheckForRayCaster()
        {
            ...
            RaycastSelector inputSystem = (RaycastSelector)Object.FindFirstObjectByType(typeof(RaycastSelector), true);
#else
        ...
        static void CreateInputField(MenuCommand menuCommand)
        {
            ...
            bg.GetComponent<Renderer>().material = go.GetComponent<InputField>().outOfFocusBackgroundMat;
