...
namespace TinyGiantStudio.Text
{
    ...
    public class SliderEditor : Editor
    {
        ...
        SerializedProperty useEvents; //TODO
        ...
        void MainSettings()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(showMainSettings.faded))
            {
                ...
                {
                    EditorGUILayout.PropertyField(autoFocusOnGameStart, new GUIContent("Auto Focus", "If not in a list, this focuses the element on game start. \nFocused = you can type to give input."));
                }
                ...
                EditorGUILayout.PropertyField(minValue, GUILayout.MinWidth(100));
                EditorGUIUtility.labelWidth = 80;
                EditorGUILayout.PropertyField(maxValue, GUILayout.MinWidth(110));
        ...
        void VisualSettings()
        {
            ...
            EditorGUI.indentLevel = 1;
            GUILayout.BeginVertical(EditorStyles.toolbar);
            GUIContent content = new GUIContent("Visual");
        ...
        void Handle()
        {
            ...
            GUILayout.BeginHorizontal();
            MText_Editor_Methods.PriviewField(selectedHandleMat, myTarget.selectedHandleMat, "Selected");
            MText_Editor_Methods.PriviewField(unSelectedHandleMat, myTarget.unSelectedHandleMat, "unSelected");
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            MText_Editor_Methods.PriviewField(clickedHandleMat, myTarget.clickedHandleMat, "Clicked");
            MText_Editor_Methods.PriviewField(disabledHandleMat, myTarget.disabledHandleMat, "Disabled");
            GUILayout.EndHorizontal();
        }

        void ButtonInputSettings()
        {
            GUILayout.BeginVertical(EditorStyles.helpBox);
            EditorGUI.indentLevel = 1;
            GUILayout.BeginVertical(EditorStyles.toolbar);
