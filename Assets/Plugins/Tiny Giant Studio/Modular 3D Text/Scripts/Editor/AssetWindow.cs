...
namespace TinyGiantStudio.Text
{
    public class AssetWindow : EditorWindow
    {
        ...
        private readonly string version = "4.0.2";
        ...
        void OnEnable()
        {
            ...
            iconsPack = EditorGUIUtility.Load("Assets/Plugins/Tiny Giant Studio/Modular 3D Text/Utility/Editor Icons/iconsPack.png") as Texture;
        ...
        void SetupAsseblyDefinitionFilesButton()
        {
            ...
            GUILayout.Label("Assembly Definition File", groupHeaderStyle, GUILayout.MaxWidth(147));
...
//#endif
        ...
        void MoreAssets()
        {
            AssetContent("3D Icons Mega Pack", "Get a pack of useful icons to go with your 3D UI.", "Show in Asset Store", "https://assetstore.unity.com/packages/3d/gui/3d-icons-mega-pack-173600?aid=1011ljxWe&pubref=Modular3DText", iconsPack);
        }
        ...
        void ApplyDefaultButtonNormalTextSizeToScene()
        {
            ...
            {
#if UNITY_2023_1_OR_NEWER
                foreach (var button in Object.FindObjectsByType<MText_UI_Button>(FindObjectsSortMode.None))
#else
        ...
        void ApplyDefaultListNormalTextSizeToScene()
        {
            ...
            {
#if UNITY_2023_1_OR_NEWER
                foreach (var list in Object.FindObjectsByType<MText_UI_List>(FindObjectsSortMode.None))
#else
        ...
        void GenerateStyle()
        {
            ...
            if (groupHeaderStyle == null)
            {
                ...
                if (settings)
                    groupHeaderStyle.normal.textColor = settings.openedFoldoutTitleColor_darkSkin;
            }
