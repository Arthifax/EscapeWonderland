...
namespace TinyGiantStudio.Text
{
    ...
    public class Toggle : MonoBehaviour
    {
        ...
        {
            ToggleGraphic(offGraphic, false);
            ToggleGraphic(onGraphic, true);
        }
        ...
        {
            ToggleGraphic(offGraphic, true);
            ToggleGraphic(onGraphic, false);
        }
        ...
        {
            UnityEditor.Events.UnityEventTools.AddPersistentListener(GetComponent<Button>().onClick, delegate { ToggleState(); });
        }
#endif
    }
}