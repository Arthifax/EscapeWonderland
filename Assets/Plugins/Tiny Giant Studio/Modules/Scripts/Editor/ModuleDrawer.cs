...
namespace TinyGiantStudio.Modules
{
    public static class ModuleDrawer
    {
        ...
        public static void BaseModuleContainerList(string label, string tooltip, List<ModuleContainer> moduleContainers, SerializedProperty serializedProperty, SerializedObject soTarget)
        {
            UpdateStyles();
